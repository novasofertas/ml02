...
(function (t, e) {
  ...
  function (t) {
    ...
    var e,
      ...
      w = function (e, i) {
        if (
          !t.document.getElementById("NotiflixQuicksand") &&
          e &&
          "string" == typeof i &&
          "quicksand" === i.toLocaleLowerCase("en")
        ) {
          if (!g("head")) return !1;
          var a = t.document.createRange();
          a.selectNode(t.document.head);
          var o = a.createContextualFragment(
      ...
      X = function (a, o, n, r) {
        ...
        A++,
          ...
          e.plainText && (a = k(a)),
          !e.plainText &&
            a.length > e.messageMaxLength &&
            ((e = y(!0, e, { closeButton: !0, messageMaxLength: 100 })),
            (a =
              'HTML Tags Error: Your content length is more than "messageMaxLength" option.')),
          a.length > e.messageMaxLength &&
            (a = a.substring(0, e.messageMaxLength) + "..."),
          "shadow" === e.fontAwesomeIconStyle &&
            (p.fontAwesomeIconColor = p.background),
        ...
        e.backOverlay &&
          ...
          t.document.getElementById(d.id)
            ? 0 === B &&
              (t.document.getElementById(d.id).style.background =
                p.backOverlayColor || e.backOverlayColor)
        ...
        (x.id = e.ID + "-" + A),
          (x.className =
            ...
            (e.closeButton && "function" != typeof o
              ...
              : "") +
            " " +
            ("function" == typeof o ? "with-callback" : "") +
            " " +
            (e.clickToClose ? "click-to-close" : "")),
          ...
          e.rtl && (x.setAttribute("dir", "rtl"), x.classList.add("rtl-on")),
        ...
        if (
          ...
          x.innerHTML =
            '<i style="color:' +
            p.fontAwesomeIconColor +
            "; font-size:" +
            e.fontAwesomeIconSize +
            ';" class="nmi wfa ' +
            p.fontAwesomeClassName +
            " " +
            ("shadow" === e.fontAwesomeIconStyle ? "shadow" : "basic") +
        ...
        if (e.useIcon) {
          var h = t.document.getElementById(x.id).querySelectorAll(".nmi")[0],
            v = 40;
          if (e.useFontAwesome) v = Math.round(parseInt(h.offsetHeight));
          else {
            var N = h.getBBox();
        ...
        if (e.showOnlyTheLastOne && 0 < A)
          for (
            var E,
              D = t.document.querySelectorAll(
                "[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + A + "])"
              ),
              T = 0;
            T < D.length;
            T++
          )
            (E = D[T]), null !== E.parentNode && E.parentNode.removeChild(E);
        e = y(!0, e, m);
      },
      F = function (e, a, o, n, r, l) {
        ...
        "string" != typeof e && (e = "Notiflix " + l),
          ...
          i.plainText && ((e = k(e)), (a = k(a)), (o = k(o))),
          i.plainText ||
            (e.length > i.titleMaxLength &&
              ((e = "HTML Tags Error"),
              (a =
                'Your Title content length is more than "titleMaxLength" option.'),
              (o = "Okay")),
            ...
            o.length > i.buttonMaxLength &&
              ...
              (o = "Okay"))),
          e.length > i.titleMaxLength &&
            (e = e.substring(0, i.titleMaxLength) + "..."),
          a.length > i.messageMaxLength &&
        ...
        (d.id = m.ID),
          ...
          i.rtl && (d.setAttribute("dir", "rtl"), d.classList.add("rtl-on")),
        ...
        if (
          ("Success" === l
            ? (b = h(i.svgSize, f.svgColor))
            : "Failure" === l
            ? (b = v(i.svgSize, f.svgColor))
            : "Warning" === l
            ? (b = N(i.svgSize, f.svgColor))
            : "Info" == l && (b = z(i.svgSize, f.svgColor)),
          (d.innerHTML =
            x +
            '<div class="' +
            i.className +
          ...
          w.addEventListener("click", function () {
            "function" == typeof n && n(), u.classList.add("remove");
            var t = setTimeout(function () {
      ...
      E = function (e, i, o, n, r, l, m, p, f) {
        ...
        "object" != typeof m || Array.isArray(m) || (a = y(!0, a, m)),
          ...
          a.plainText && ((e = k(e)), (i = k(i)), (o = k(o)), (n = k(n))),
          a.plainText ||
            ...
            i.length > a.messageMaxLength &&
              ...
              (o = "Okay"),
              (n = "...")),
            (o.length || n.length) > a.buttonsMaxLength &&
              ((e = "HTML Tags Error"),
              (i =
              ...
              (n = "..."))),
          e.length > a.titleMaxLength &&
            (e = e.substring(0, a.titleMaxLength) + "..."),
          i.length > a.messageMaxLength &&
            (i = i.substring(0, a.messageMaxLength) + "..."),
          o.length > a.buttonsMaxLength &&
            (o = o.substring(0, a.buttonsMaxLength) + "..."),
          n.length > a.buttonsMaxLength &&
            (n = n.substring(0, a.buttonsMaxLength) + "..."),
        ...
        (x.id = c.ID),
          (x.className =
            a.className +
            (a.cssAnimation
              ? " with-animation nx-" + a.cssAnimationStyle
              : "")),
          (x.style.zIndex = a.zindex),
          (x.style.padding = a.distance),
          a.rtl && (x.setAttribute("dir", "rtl"), x.classList.add("rtl-on"));
        ...
        if (
          ...
          if (
            ...
            z.addEventListener("click", function (t) {
              ...
              "function" == typeof r && r(), N.classList.add("remove");
            ...
            S.addEventListener("click", function () {
              "function" == typeof l && l(), N.classList.add("remove");
              var t = setTimeout(function () {
                null !== N.parentNode &&
      ...
      D = function (e, i, a, n, r) {
        ...
        var c = "";
        if (("string" == typeof e && 0 < e.length && (c = e), n)) {
          c =
            c.toString().length > o.messageMaxLength
              ? k(c).toString().substring(0, o.messageMaxLength) + "..."
              : k(c).toString();
          var f = "";
          0 < c.length &&
            (f =
          ...
          var x = "";
          if ("standard" === a) x = C(o.svgSize, o.svgColor);
          else if ("hourglass" === a) x = S(o.svgSize, o.svgColor);
          else if ("circle" === a) x = W(o.svgSize, o.svgColor);
          else if ("arrows" === a) x = I(o.svgSize, o.svgColor);
          else if ("dots" === a) x = L(o.svgSize, o.svgColor);
          ...
          if (
            ...
            (v.className =
              o.className +
              (o.cssAnimation ? " with-animation" : "") +
              (o.clickToClose ? " click-to-close" : "")),
            ...
            o.rtl && (v.setAttribute("dir", "rtl"), v.classList.add("rtl-on")),
            (v.innerHTML = h + f),
            !t.document.getElementById(v.id) &&
              (t.document.body.appendChild(v), o.clickToClose))
          ) {
            ...
            N.addEventListener("click", function () {
              ...
              var t = setTimeout(function () {
                null !== v.parentNode &&
                  (v.parentNode.removeChild(v), clearTimeout(t));
      ...
      T = function (e) {
        ...
        if (i)
          if (0 < e.length) {
            e =
              e.length > o.messageMaxLength
                ? k(e).substring(0, o.messageMaxLength) + "..."
                : k(e);
      ...
      O = function (e, a, o, r, l, m) {
        ...
        var h =
            "number" == typeof n.querySelectorLimit
              ? n.querySelectorLimit
              : 200,
        ...
        if (e)
          for (var N = 0; N < v; N++) {
            ...
            if (1 > M.length) {
              ...
              o &&
                ("hourglass" === o
                  ? (A = S(n.svgSize, n.svgColor))
                  : "circle" === o
                  ? (A = W(n.svgSize, n.svgColor))
                  : "arrows" === o
                  ? (A = I(n.svgSize, n.svgColor))
                  : "dots" === o
                  ? (A = L(n.svgSize, n.svgColor))
                  : "pulse" === o
                  ? (A = R(n.svgSize, n.svgColor))
              ...
              0 < u.length &&
                ((u =
                  u.length > n.messageMaxLength
                    ? k(u).substring(0, n.messageMaxLength) + "..."
                    : k(u)),
                (X =
              ...
              (F.id = f.ID + "-" + j),
                (F.className =
                  w + "-wrap" + (n.cssAnimation ? " with-animation" : "")),
                ...
                (F.style.justifyContent = "center"),
                n.rtl &&
                  (F.setAttribute("dir", "rtl"), F.classList.add("rtl-on")),
                (F.innerHTML = B + X);
              var E = t.getComputedStyle(z).getPropertyValue("position"),
                D =
                  "string" == typeof E ? E.toLocaleLowerCase("en") : "relative",
              ...
              Q = z.getAttribute("id")
                ...
                : z.classList[0]
                ? "." + z.classList[0]
                : (z.tagName || "").toLocaleLowerCase("en");
              var Y = "",
                G =
                  -1 >= ["absolute", "relative", "fixed", "sticky"].indexOf(D);
              if (G || 0 < P.length) {
                if (!g("head")) return !1;
            ...
            $ = function (t) {
              if (t && 0 < t.length)
                for (var e, o = 0; o < t.length; o++)
                  (e = t[o]), e && (e.classList.add("remove"), K(e));
              else
                x(
                  "Notiflix Info",
      ...
      H = {
        Notify: {
          Init: function (t) {
            (e = y(!0, l, t)), w(e.useGoogleFont, e.fontFamily), u();
          },
          Merge: function (t) {
            return e
              ? void (e = y(!0, e, t))
        ...
        Report: {
          Init: function (t) {
            (i = y(!0, m, t)), w(i.useGoogleFont, i.fontFamily), u();
          },
          Merge: function (t) {
            return i
              ? void (i = y(!0, i, t))
        ...
        Confirm: {
          Init: function (t) {
            (a = y(!0, c, t)), w(a.useGoogleFont, a.fontFamily), u();
          },
          Merge: function (t) {
            return a
              ? void (a = y(!0, a, t))
        ...
        Loading: {
          Init: function (t) {
            (o = y(!0, p, t)), w(o.useGoogleFont, o.fontFamily), u();
          },
          Merge: function (t) {
            return o
              ? void (o = y(!0, o, t))
          ...
          Remove: function (t) {
            "number" != typeof t && (t = 0), D(!1, !1, !1, !1, t);
          },
          Change: function (t) {
            T(t);
          },
        ...
        Block: {
          Init: function (t) {
            (n = y(!0, f, t)), w(n.useGoogleFont, n.fontFamily), u();
          },
          Merge: function (t) {
            return n
              ? void (n = y(!0, n, t))
          ...
          Remove: function (t, e) {
            "number" != typeof e && (e = 0), O(!1, t, !1, !1, !1, e);
          },
        },
      };
    return {
